    ...
    if (event.target.classList.contains("recalculate-button")) {
      ...
      if (calculatorRight) {
        ...
        if (listaRecomendaciones)
          listaRecomendaciones.innerHTML = `<li>Esperando tu cálculo...</li><li>Esperando tu cálculo...</li><li>Esperando tu cálculo...</li><li>Esperando tu cálculo...</li><li>Esperando tu cálculo...</li><li>Esperando tu cálculo...</li>`;
